...
public class Main_WavBootLoader extends JPanel {
    ...
    public Main_WavBootLoader() {
        ...
        frame.getContentPane().setLayout(null); // kein Layout Manager f�r freie Gr��enwahl
    ...
    class writeWav_ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                WavCodeGenerator.convertHex2Wav(new File(setupData.getInputHexFile().toURI()), setupData.getOutputWavFile());
            } catch (Exception e1) {
                // TODO Auto-generated catch block
                e1.printStackTrace();
            }
            ...
            new AePlayWave(setupData.getOutputWavFile().toString(),p).start();
            testText.append("done\n");
